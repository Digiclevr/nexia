...
export default function DashboardPage() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 border-b border-blue-700 flex-shrink-0 overflow-x-auto">
        <div className="flex items-center justify-between px-2 lg:px-4 py-1 min-w-max">
      ...
      <div className="flex-1 overflow-hidden p-2 lg:p-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 h-full max-h-full">
          ...
          <div className="lg:col-span-2 bg-white border border-gray-200 rounded overflow-hidden">
            <div className="p-2 border-b bg-gray-50 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <select className="text-xs border-gray-300 rounded px-2 py-1">
              ...
              <table className="w-full text-xs">
                <thead className="bg-gray-50 sticky top-0">
                  <tr>
                    ...
                    <th className="px-2 py-1 text-left font-medium text-gray-500">Rev/M</th>
                    <th className="px-2 py-1 text-left font-medium text-gray-500">Trafic</th>
                    <th className="px-2 py-1 text-left font-medium text-gray-500">Conv</th>
                    <th className="px-2 py-1 text-left font-medium text-gray-500">SEO</th>

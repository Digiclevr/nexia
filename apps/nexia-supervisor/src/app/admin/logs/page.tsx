...
export default function LogsSystemPage() {
        ...
        <div className="flex items-center justify-between px-2 lg:px-4 py-2">
          <div className="flex items-center min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-sm lg:text-lg font-semibold text-gray-900 truncate">Logs System</h1>
            </div>
          </div>
      ...
      <div className="flex-1 overflow-hidden p-2 lg:p-3">
        <div className="bg-white border border-gray-200 rounded p-4 h-full flex items-center justify-center">
          <div className="text-center">
            ...
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Logs System</h2>
            <p className="text-gray-600">Interface Logs System</p>
          </div>
        </div>
      </div>
    </div>
